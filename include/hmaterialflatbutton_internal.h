#ifndef HMATERIALFLATBUTTON_INTERNAL_H
#define HMATERIALFLATBUTTON_INTERNAL_H
...
class HMaterialFlatButtonStateMachine : public QStateMachine
{
    Q_OBJECT
...
public:
    explicit HMaterialFlatButtonStateMachine(HMaterialFlatButton *parent = nullptr);
    ~HMaterialFlatButtonStateMachine();
...
private:
    Q_DISABLE_COPY(HMaterialFlatButtonStateMachine)
    ...
    HMaterialFlatButton         *const m_button;
...
inline qreal HMaterialFlatButtonStateMachine::overlayOpacity() const
{
    return m_overlayOpacity;
}

inline qreal HMaterialFlatButtonStateMachine::checkedOverlayProgress() const
{
    return m_checkedOverlayProgress;
}

inline qreal HMaterialFlatButtonStateMachine::haloOpacity() const
{
    return m_haloOpacity;
}

inline qreal HMaterialFlatButtonStateMachine::haloSize() const
{
    return m_haloSize;
}

inline qreal HMaterialFlatButtonStateMachine::haloScaleFactor() const
{
