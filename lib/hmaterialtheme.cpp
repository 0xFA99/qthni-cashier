...
#include "hmaterialtheme_p.h"
#include "hmaterialtheme.h"

HMaterialThemePrivate::HMaterialThemePrivate(HMaterialTheme *q)
    : q_ptr(q)
{
}

HMaterialThemePrivate::~HMaterialThemePrivate()
{
}

QColor HMaterialThemePrivate::rgba(int red, int green, int blue, qreal alpha) const
{
...
HMaterialTheme::HMaterialTheme(QObject *parent)
    : QObject(parent),
      d_ptr(new HMaterialThemePrivate(this))
{
    setColor("primary1", HMaterial::cyan500);
    setColor("primary2", HMaterial::cyan700);
    setColor("primary3", HMaterial::lightBlack);
    setColor("accent1", HMaterial::pinkA200);
    setColor("accent2", HMaterial::grey100);
    setColor("accent3", HMaterial::grey500);
    setColor("text", HMaterial::darkBlack);
    setColor("alternateText", HMaterial::white);
    setColor("canvas", HMaterial::white);
    setColor("border", HMaterial::grey300);
    setColor("disabled", HMaterial::minBlack);
    setColor("disabled2", HMaterial::faintBlack);
    setColor("disabled3", HMaterial::grey300);
}

HMaterialTheme::~HMaterialTheme()
{
}

QColor HMaterialTheme::getColor(const QString &key) const
{
    Q_D(const HMaterialTheme);
...
void HMaterialTheme::setColor(const QString &key, const QColor &color)
{
    Q_D(HMaterialTheme);
...
void HMaterialTheme::setColor(const QString &key, HMaterial::Color color)
{
    Q_D(HMaterialTheme);
...
QIcon HMaterialTheme::icon(QString category, QString icon)
{
