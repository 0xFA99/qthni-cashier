...
HMaterialTextFieldStateMachine::HMaterialTextFieldStateMachine(HMaterialTextField *parent)
...
HMaterialTextFieldStateMachine::~HMaterialTextFieldStateMachine()
{
}

void HMaterialTextFieldStateMachine::setLabel(HMaterialTextFieldLabel *label)
{
    if (m_label)
        delete m_label;
...
void HMaterialTextFieldStateMachine::setupProperties()
{
    if (m_label) {
...
HMaterialTextFieldLabel::HMaterialTextFieldLabel(HMaterialTextField *parent)
    : QWidget(parent),
      m_textField(parent),
      m_scale(1),
      m_posX(0),
...
HMaterialTextFieldLabel::~HMaterialTextFieldLabel()
{
}

void HMaterialTextFieldLabel::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
