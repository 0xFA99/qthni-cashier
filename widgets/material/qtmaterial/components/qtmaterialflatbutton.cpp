...
#include "qtmaterial/components/qtmaterialflatbutton_p.h"
#include <QPainter>
#include <QMouseEvent>
#include <QBitmap>
...
#include "qtmaterial/components/qtmaterialflatbutton_internal.h"
...
void QtMaterialFlatButton::mousePressEvent(QMouseEvent *event)
{
    ...
    if (Material::NoRipple != d->rippleStyle)
    {
        ...
        auto *ripple = new QtMaterialRipple(pos);
